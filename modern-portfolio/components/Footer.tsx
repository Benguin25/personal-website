...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark-950/50 backdrop-blur-md border-t border-white/10 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-xl font-bold gradient-text mb-4">Get In Touch</h3>
          ...
          >
            ...
            <div className="space-y-2 text-gray-300">
              <a href="/about" className="block hover:text-primary-400 transition-colors duration-300">
                About Me
              </a>
              <a href="/projects" className="block hover:text-primary-400 transition-colors duration-300">
                Projects
              </a>
