            ...
            >
              ...
              >
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-3 rounded-xl font-semibold text-sm transition-colors duration-200"
                >
